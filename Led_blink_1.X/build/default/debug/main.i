...
main:
        ...
        ;---------------------------------------------------------------
        ; 2) Configurar oscilador interno a 8 MHz (solo si 1=1)
...
wait_osc:
        ; Esperar a que ((OSCCON) and 0FFh), 2, a=1 (bit2) indique frecuencia estable
        btfss OSCCON, 2, c
        goto wait_osc
        ...
        bcf LATD, 0, c ; activo-alto: 0 apaga
...
led_on:
        ...
        bsf LATD, 0, c ; activo-alto: 1 enciende
...
delay_10ms:
        ...
        ; 2) clear overflow flag (((PIR1) and 0FFh), 0, a = PIR1,0)
        bcf PIR1, 0, c
